...
---
> **АРХИВ (ТВОЙ ХОД)** — studio/GDD-наследие, `disable-model-invocation`. **Не используй** пути `design/gdd/`, `design/ux/`, `.claude/design/` — в этом репозитории их нет.
>
...
**Gate:** документ онбординга считается готовым только после явного **APPROVED** от пользователя (или правок по замечаниям). Без APPROVED — **NEEDS REVISION**, не переходи к «первой задаче» в прод-коде.

Verdict: **COMPLETE** (или **APPROVED** / **NEEDS REVISION** / **CONCERNS**) — onboarding document generated.

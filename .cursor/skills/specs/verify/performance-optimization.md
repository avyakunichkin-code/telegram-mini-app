# Skill Test Spec: /performance-optimization

**Skill:** `.cursor/skills/performance-optimization/SKILL.md`  
**Category:** verify · **Priority:** medium

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec performance-optimization`.
...
- Пользователь вызывает `/performance-optimization` с аргументом из `argument-hint`.

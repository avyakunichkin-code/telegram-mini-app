# Skill Test Spec: /security-and-hardening

**Skill:** `.cursor/skills/security-and-hardening/SKILL.md`  
**Category:** verify · **Priority:** medium

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec security-and-hardening`.
...
- Пользователь вызывает `/security-and-hardening` с аргументом из `argument-hint`.

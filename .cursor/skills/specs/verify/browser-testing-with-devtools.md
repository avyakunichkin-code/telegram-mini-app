# Skill Test Spec: /browser-testing-with-devtools

**Skill:** `.cursor/skills/browser-testing-with-devtools/SKILL.md`  
**Category:** verify · **Priority:** medium

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec browser-testing-with-devtools`.
...
- Пользователь вызывает `/browser-testing-with-devtools` с аргументом из `argument-hint`.

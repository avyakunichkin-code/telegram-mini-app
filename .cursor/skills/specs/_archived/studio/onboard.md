...
**Skill:** `.cursor/skills/_archived/onboard/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec onboard`.
...
- Пользователь вызывает `/onboard` с аргументом из `argument-hint`.

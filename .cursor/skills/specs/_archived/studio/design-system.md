...
**Skill:** `.cursor/skills/_archived/design-system/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec design-system`.
...
- Пользователь вызывает `/design-system` с аргументом из `argument-hint`.

...
**Skill:** `.cursor/skills/_archived/ux-review/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec ux-review`.
...
- Пользователь вызывает `/ux-review` с аргументом из `argument-hint`.

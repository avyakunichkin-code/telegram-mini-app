...
**Skill:** `.cursor/skills/_archived/retrospective/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec retrospective`.
...
- Пользователь вызывает `/retrospective` с аргументом из `argument-hint`.

...
**Skill:** `.cursor/skills/_archived/brainstorm/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec brainstorm`.
...
- Пользователь вызывает `/brainstorm` с аргументом из `argument-hint`.

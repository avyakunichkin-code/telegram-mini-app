...
**Skill:** `.cursor/skills/_archived/team-ui/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec team-ui`.
...
- Пользователь вызывает `/team-ui` с аргументом из `argument-hint`.

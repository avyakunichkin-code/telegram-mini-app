...
**Skill:** `.cursor/skills/_archived/ux-design/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec ux-design`.
...
- Пользователь вызывает `/ux-design` с аргументом из `argument-hint`.

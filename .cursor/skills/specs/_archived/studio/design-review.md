...
**Skill:** `.cursor/skills/_archived/design-review/SKILL.md`  
**Category:** studio · **Priority:** studio

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec design-review`.
...
- Пользователь вызывает `/design-review` с аргументом из `argument-hint`.

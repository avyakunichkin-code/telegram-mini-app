...
**Skill:** `.cursor/skills/skill-test/SKILL.md`  
**Category:** meta · **Priority:** meta

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec skill-test`.
...
- Пользователь вызывает `/skill-test` с аргументом из `argument-hint`.

# Skill Test Spec: /social-changelog-posts

**Skill:** `.cursor/skills/social-changelog-posts/SKILL.md`  
**Category:** ship · **Priority:** medium

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec social-changelog-posts`.
...
- Пользователь вызывает `/social-changelog-posts` с аргументом из `argument-hint`.

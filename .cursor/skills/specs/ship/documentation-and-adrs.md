# Skill Test Spec: /documentation-and-adrs

**Skill:** `.cursor/skills/documentation-and-adrs/SKILL.md`  
**Category:** ship · **Priority:** medium

> Stub: расширить по [`templates/skill-test-spec.md`](../templates/skill-test-spec.md) перед строгим `/skill-test spec documentation-and-adrs`.
...
- Пользователь вызывает `/documentation-and-adrs` с аргументом из `argument-hint`.

...
**Игрок приходит на главную, чтобы за один закрытый период (опытный **~1–3 мин**, новичок **5–10 мин**; канон [`TARGET_PLAYER_AND_SESSION.md`](../../foundation/TARGET_PLAYER_AND_SESSION.md) §2):**

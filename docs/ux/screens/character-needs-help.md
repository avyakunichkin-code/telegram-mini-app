...
├─────────────────────────────────────┤
│ ▼ Повседневно (maintenance)         │
│   • Закрывай события…               │
│   • «Порадовать себя» — редко…      │
│ ▼ Если просело (critical)           │
│   • Ниже 30% — штраф…               │
│   • Ноль 3 месяца — поражение…      │
├─────────────────────────────────────┤
│ [        Понятно        ]           │
└─────────────────────────────────────┘
```

- Два аккордеона или два `h3` блока без collapse (проще для MVP).
- Контент с сервера; soft/hard — разные bullet в `critical` при необходимости.
...
2. Показаны оба раздела maintenance и critical.

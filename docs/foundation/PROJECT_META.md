...
|--------|-----|-------------|
| ✅ Закрыто в коде / P1 | **G1**, **M11**, **V2**, **I1**, **T1**, **O1** | Plan UI — MVP 2.0 |
| 🟡 В работе / частично | **α**, **A0**, **TG1**, **CN1**, **PW1**, **AF1** | α: KPI ✅, волна PA-W1 ⬜; A0: notify RU ✅, A2 ⬜; TG1: ops ✅, env ⬜ |
| ⏸ На паузе (2026-05-30) | **M12**, **E1** | idea-refine / ждём spec |

**Грубо:** ~6 эпиков «основной контур сделан», ~6 «в полёте», ~2 пауза.

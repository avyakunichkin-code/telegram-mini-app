...
1. **Поднять `EVENTS_PER_PERIOD` до 3** — отклонено: anti-fatigue; канон **~5–10 мин на закрытый период**, **2 события** ([`TARGET_PLAYER_AND_SESSION`](../foundation/TARGET_PLAYER_AND_SESSION.md) §2).

...
| **M12** | Достижения — цепочки tier, XP | GAME §5, [GAME.md](../GAME.md) | [SPEC_achievements](specs/features/SPEC_achievements.md) **approved** §11 B+C | [design-lab/achievements-progress](../design-lab/achievements-progress/) | [M12 в backlog](backlog/PRODUCT_BACKLOG.md) | **in dev**: BE+тосты ✅; UI: lab → collapsible level + каталог |

...
| **M1.2** | MVP 1.2 — Game для своих | [post-playtest §1.2](vision/ideas/post-playtest-wave1-two-directions.md) | EVT1, V2-BAL (частично) | — | [M1.2 в backlog](backlog/PRODUCT_BACKLOG.md) | **approved**; P0 = PLT |
| **M2.0** | MVP 2.0 — Plan для своих | [post-playtest §2.0](vision/ideas/post-playtest-wave1-two-directions.md) · [expenses-mechanic](vision/ideas/expenses-mechanic.md) | [SPEC_expenses](specs/features/SPEC_expenses.md) **draft** · ⚠ P2-ONB квиз · **AN1** | [PLAN_expenses](plans/PLAN_expenses.md) | [M2.0 / AN1 в backlog](backlog/PRODUCT_BACKLOG.md) | **approved**; квиз по тапу Plan |

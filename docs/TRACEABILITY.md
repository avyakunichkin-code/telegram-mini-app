...
| **V2** | Victory M из N из шаблона | [evolution §II](vision/ideas/money-quest-evolution-after-mvp.md) | [SPEC_victory-v2](specs/features/SPEC_victory-v2.md) **approved** | — | [V2 в backlog](backlog/PRODUCT_BACKLOG.md) | **implemented** backend (`victory_engine`, `overview.victory`); **UI** прогресса целей — backlog |

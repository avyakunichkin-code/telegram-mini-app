...
2. **Plan Mode:** мастер, префилл **`starter_params_json`**, активация плитки Plan — см. бэклог P1.
3. **Victory v2:** движок **M из N** и использование **`avg_net_cashflow_6p`** в условиях победы.
4. Бейджи **`game`/`plan`** и метка сложности шаблона в списке сохранений.

...
| **T1** | Turn-based период без таймера | [turn-based-period-no-timer](vision/ideas/turn-based-period-no-timer.md) | ⚠ UX dashboard | — | [T1 в backlog](backlog/PRODUCT_BACKLOG.md) | **deferred** (не спринт май 2026) |

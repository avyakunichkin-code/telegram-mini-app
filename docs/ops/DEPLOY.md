...
Resume после блокировки экрана (PW1): [`foundation/PW1_RESUME_PLAYTEST_CHECKLIST.md`](../foundation/PW1_RESUME_PLAYTEST_CHECKLIST.md).  
Установка PWA: [`foundation/PWA_INSTALL.md`](../foundation/PWA_INSTALL.md).

...
- `dashboard_core` — зарплата, подушка, период/закрытие месяца (TB1, всегда).
...
- [ ] **3–5 tutorial-целей + 2–3 пороговые** укладываются в **одну TMA-сессию** (15–25 мин) при пошаговом закрытии месяцев (TB1).

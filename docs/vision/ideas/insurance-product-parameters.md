...
Как оформить страховку в Money Quest как узнаваемый страховой продукт (продукт × объект), с понятной экономикой на экране и заделом под события, без лишней сложности реального рынка?
...
- **Не в MVP:** франшиза, исключения, co-pay, период лимита, привязка к конкретному активу (v2).
...
- Привязка полиса к `finance_assets.id`.

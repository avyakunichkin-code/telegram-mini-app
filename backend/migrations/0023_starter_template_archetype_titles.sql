...
UPDATE game_starter_templates SET
  ...
  blueprint_json = $json$
{"description":"Два долга, плотный кэш и насыщенный период — максимум финансовых решений за цикл.","scenario_icon":"debt_stack","compare_note":"Максимум решений за период — твой драйв, если любишь плотный ритм.","highlights":["Доход ~43 500 ₽/мес","Расходы на жизнь ~19 600 ₽/мес","Ипотека + кредитная карта","Подержанное авто","На счёте ~4 500 ₽"],"period_duration_seconds":300,"cash_balance":4500,"monthly_salary":43500,"assets":[{"title":"Подержанное авто","kind":"vehicle","asset_value":145000,"monthly_maintenance_cost":2900,"monthly_income":0}],"liabilities":[{"title":"Ипотека","total_debt":520000,"annual_rate_percent":14},{"title":"Кредитная карта","total_debt":110000,"annual_rate_percent":24}]}
$json$::text

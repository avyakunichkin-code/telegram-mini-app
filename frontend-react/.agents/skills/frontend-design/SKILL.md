...
- **Порядок табов страницы (утверждено):** Инвестиции → **Бюджет** → Страховки → **Имущество** → **Обязательства**. Бюджет — вкладка, не блок над табами. Макет: [`design-lab/capital-page/`](../../../../design-lab/capital-page/).

/** Декоративные иллюстрации режимов — линейный стиль, цвета из палитры MQ (не «стоковый» AI-градиент). */
...
export function IllustrationGame({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 72 72" width={72} height={72} aria-hidden fill="none">
      ...
      <path d="M22 26l8-10 10 12 10-14 8 12" stroke="currentColor" strokeWidth={2} strokeLinecap="round" opacity={0.45} />
    </svg>
  );
}
...
export function IllustrationPlan({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 72 72" width={72} height={72} aria-hidden fill="none">
      ...
      <path d="M22 42l10-12 8 10 14-18" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" opacity={0.55} />

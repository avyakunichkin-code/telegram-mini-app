...
const DEFEAT_COPY = {
  cash_negative_streak: {
    ...
    body: [
      ...
      'В течение хода баланс мог быть в плюсе — но расходы на жизнь, кредиты и обязательства списываются в конце хода. Планируй «Завершить ход» с учётом этих списаний.',
    ],
        ...
        <div className="mqx-juice-warn-modal__head">
          ...
          <div className="mqx-juice-warn-modal__copy">
            <p className="mqx-juice-warn-modal__kicker">
              {defeatPeriodIndex ? `Ход ${defeatPeriodIndex}` : 'Поражение'}
            </p>

import monetkaDefault from '../../../assets/monetka-mascot.png';
import monetkaSitEdge from '../../../assets/monetka-poses/monetka-sit-edge.png';
 ...
 * sit-edge — сидит на краю блока, ноги свисают (PNG с alpha).
 */
